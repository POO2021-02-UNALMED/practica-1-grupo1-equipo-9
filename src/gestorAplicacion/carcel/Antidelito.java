...
public class Antidelito {
	...
	public static Hashtable<Integer, Antidelito> getAntidelitos() {
		return antidelitos;
	}
	...
	public long getRebajaCondena() {
		return rebajaCondena;
	}

	public void setRebajaCondena(long rebajaCondena) {
		this.rebajaCondena = rebajaCondena;
	}
